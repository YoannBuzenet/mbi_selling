    ...
    return await db.MkmProduct.bulkCreate(
      [
        ...
        //Testing ruleTypeId 2 : this card should have +15%
        {
          ...
          isPlayset: 0,
          isAltered: 0,
          comments: "testSeedKeyword Script 5",
          amount: 6,
          onSale: 0,
          productLegalityId: 16,
          idCurrency: 1,
          currencyCode: "EUR",
          idShop: 57,
          createdAt: new Date(),
        ...
        //Testing ruleTypeId 2 : this card should have ruletype 1 (set value)
        {
          ...
          isPlayset: 0,
          isAltered: 0,
          comments: "testSeedKeyword Script 6",
          amount: 2,
          onSale: 0,
          idCurrency: 1,
          productLegalityId: 17,
          currencyCode: "EUR",
          idShop: 57,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        //Used to test behaviour definition 18
        {
          idArticle: 181,
          idProduct: 107,
          ...
          isPlayset: 0,
          isAltered: 0,
          comments: "foil shoud get round up 15 euros",
          amount: 10,
          onSale: 0,
          idCurrency: 1,
          productLegalityId: 9,
        ...
        // This card is used to test oldPrice script, custom rule between 10 and 20 should give Excluded
        {
          idArticle: 182,
          idProduct: 16229,
          englishName: "ok",
