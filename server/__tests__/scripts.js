...
describe("First Script", () => {
  ...
  describe("Card, Article X", () => {
    it("should have an old price of X", {});
    it("should have an new price of X", {});
    it("should have a bavhiour chosen of X", {});
    it("should have a priceshield deactivated", {});
    it("should have an id Script of X", {});
    it("should have an id Product of X", {});
    it("should have a lang : X", {});
    it("should have isFoil : X", {});
    it("should have an isSigned : X", {});
    it("should have an is playset : X", {});
    it("should have an amount of X", {});
    it("should have an put request id of X", {});
  });
  describe("Card, Article X", () => {
    it("should have an old price of X", {});
    it("should have an new price of X", {});
