    ...
    <div className="container terms-and-conditions-page">
      ...
      <p>
        <FormattedMessage
          ...
          defaultMessage="Competent jurisdiction These Terms and Conditions are subject to interpretation and performance under French law. Any dispute between MTGINTERFACE and the MERCHANT relating to the existence, validity, interpretation or performance of the Terms and Conditions or of any of their clauses that the parties are unable to resolve amicably shall be ruled by the Paris courts."
        />
      </p>
    </div>
  );
